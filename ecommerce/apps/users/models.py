...
class UserManager(BaseUserManager):
    ...
    def create_user(self, username, email, name, last_name,
    ...
    def create_superuser(self, username, email, name, last_name,
                         password=None, **extra_fields):
        return self._create_user(username, email, name, last_name,
...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    last_name = models.CharField('Apellidos', max_length=255, blank=True,
                                 null=True)
    image = models.ImageField('Imagen de perfil', upload_to='perfil_image/',
